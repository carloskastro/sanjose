...
<body>
    ...
    if (isset($_POST['regadmin'])) {
        ...
        $data = $regadm->runQuery("SELECT * FROM adm WHERE email=:email");
        ...
        if ($data->rowCount() > 0) {
            ...
            if ($regadm->reg_adm($fname, $lname, $email, $pass)) {
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    <h1 class="display-6">Registro de Admin</h1>
                </div>
                <form action="" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-block" name="regadmin">Registrar</button>
                    </div>
                </form>
            </div>
        </div>
